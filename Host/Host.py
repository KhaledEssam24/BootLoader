...
def Decode_CBL_Command(Command):
    ...
    if(Command == 0):
        print("Switch To APP")
        SWITCH_TO_APP_CMD_Len = 6
        BL_Host_Buffer[0] = SWITCH_TO_APP_CMD_Len - 1
        BL_Host_Buffer[1] = SWITCH_TO_APP_CMD
        CRC32_Value = Calculate_CRC32(BL_Host_Buffer, SWITCH_TO_APP_CMD_Len - 4)
        ...
        for Data in BL_Host_Buffer[1 : SWITCH_TO_APP_CMD_Len]:
            Write_Data_To_Serial_Port(Data, SWITCH_TO_APP_CMD_Len - 1)
        Read_Data_From_Serial_Port(SWITCH_TO_APP_CMD)
